...
from app.stgcn_plus_plus.graph import Graph
from app.stgcn_plus_plus.gcn import unit_gcn
from app.stgcn_plus_plus.tcn import mstcn, unit_tcn
...
class STGCN(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.data_bn_type == 'MVC':
            ...
            x = self.data_bn(x.view(N * M, V * C, T)) # 对骨骼点和C特征的 T维度进行bn
