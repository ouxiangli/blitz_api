...
from app.stgcn_plus_plus.init_func import bn_init, conv_init
...
class unit_tcn(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=9, stride=1, dilation=1, norm='BN', dropout=0):
        ...
        self.conv = nn.Conv2d(
            ...
            stride=(stride, 1),
            dilation=(dilation, 1))
        self.bn = nn.BatchNorm2d(out_channels, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True) if norm is not None else nn.Identity()
